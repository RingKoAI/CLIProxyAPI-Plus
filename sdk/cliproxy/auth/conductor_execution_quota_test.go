...
func TestApplyRequestAfterAuthInterceptorSessionClearing(t *testing.T) {
	...
	finalReq, finalOpts, err := applyRequestAfterAuthInterceptor(nil, context.Background(), nil, "openai", req, opts, "gpt-5.6-luna")
	if err != nil {
...
func TestApplyRequestAfterAuthInterceptorPreservesOriginalRequestSessionOnUnrelatedHeaderChange(t *testing.T) {
	...
	_, finalOpts, err := applyRequestAfterAuthInterceptor(nil, context.Background(), nil, "openai", req, opts, "gpt-5.6-luna")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
